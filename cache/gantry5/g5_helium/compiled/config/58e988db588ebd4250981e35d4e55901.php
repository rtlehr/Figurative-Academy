...
return [
    ...
    'timestamp' => 1517924791,
    'checksum' => 'fb965a6954d897ca320b708f35d40712',
    'files' => [
        'templates/g5_helium/custom/config/20' => [
            'index' => [
                'file' => 'templates/g5_helium/custom/config/20/index.yaml',
                'modified' => 1512504191
            ],
            'layout' => [
                'file' => 'templates/g5_helium/custom/config/20/layout.yaml',
                'modified' => 1512504191
            ],
            'page/assets' => [
                'file' => 'templates/g5_helium/custom/config/20/page/assets.yaml',
                'modified' => 1517924791
            ],
            'styles' => [
                'file' => 'templates/g5_helium/custom/config/20/styles.yaml',
                'modified' => 1512504279
            ]
        ],
    ...
    'data' => [
        ...
        'page' => [
            ...
            'assets' => [
                'css' => [
                    0 => [
                        'location' => '/assets/css/templateBase.css',
                        'inline' => '',
                        'extra' => [
                            
                        ],
                        'priority' => '0',
                        'name' => 'templateBase.css'
                    ]
                ]
            ]
        ],

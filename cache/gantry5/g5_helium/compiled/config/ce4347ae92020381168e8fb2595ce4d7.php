...
return [
    ...
    'timestamp' => 1517924845,
    'checksum' => '5777f6ea5cd4c8ce2db8f2f7452a5650',
    'files' => [
        'templates/g5_helium/custom/config/47' => [
            'index' => [
                'file' => 'templates/g5_helium/custom/config/47/index.yaml',
                'modified' => 1513194064
            ],
            'layout' => [
                'file' => 'templates/g5_helium/custom/config/47/layout.yaml',
                'modified' => 1513194064
            ],
            'page/assets' => [
                'file' => 'templates/g5_helium/custom/config/47/page/assets.yaml',
                'modified' => 1513684486
            ],
            'styles' => [
                'file' => 'templates/g5_helium/custom/config/47/styles.yaml',
                'modified' => 1513194064
            ]
        ],
        ...
        'page' => [
            ...
            'assets' => [
                'css' => [
                    0 => [
                        'location' => '',
                        'inline' => '.figurativeContent
{
position:relative;
top:-125px;
z-index:150;
padding:0 0 !important;
-webkit-box-shadow: 6px 6px 16px 0px rgba(0,0,0,0.3);
-moz-box-shadow: 6px 6px 16px 0px rgba(0,0,0,0.3);
...
border: thin #666666 solid;
                        ...
                        'priority' => '0',
                        'name' => 'figurativeContent'
                    ],
                    1 => [
                        'location' => '',
                        'inline' => '.figurativeContainer{
background:#F8F8FF;
}',
                        'extra' => [
     ...
     z-index:200;
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'messages' => [
                    'system-messages-8682' => 'System Messages'
                ],
                'content' => [

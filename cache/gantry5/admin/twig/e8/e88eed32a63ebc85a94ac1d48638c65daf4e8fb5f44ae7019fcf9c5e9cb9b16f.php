...
class __TwigTemplate_b76af577ba0eb78e24fb6aa5ce2443591682e85c53b061d9983b0aa920871d9b extends Twig_Template
{
    ...
    <h4>
        ...
        if ((isset($context["item"]) ? $context["item"] : null)) {
            // line 11
            echo "            ";
            $context["item_type"] = (($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "subtype", array())) ? ($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "subtype", array())) : ($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "type", array())));
            // line 12
            echo "            ";
            $context["item_disabled"] =  !$this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "config", array()), "get", array(0 => (("particles." . (isset($context["item_type"]) ? $context["item_type"] : null)) . ".enabled"), 1 => true), "method");
            // line 13
            echo "            <span class=\"badge font-small\">";
            echo twig_escape_filter($this->env, (isset($context["item_type"]) ? $context["item_type"] : null), "html", null, true);
            echo "</span>
            ";
            // line 14
            if ($this->getAttribute($this->getAttribute((isset($context["blueprints"]) ? $context["blueprints"] : null), "fields", array()), "enabled", array())) {
                // line 15
                echo "                ";
                $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/pages/configurations/layouts/particle-card.html.twig", 15)->display(array_merge($context, array("name" => (("particles." . (isset($context["item_type"]) ? $context["item_type"] : null)) . ".enabled"), "field" => $this->getAttribute($this->getAttribute((isset($context["blueprints"]) ? $context["blueprints"] : null), "fields", array()), "enabled", array()), "value" => $this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "attributes", array()), "enabled", array()), "default" => 1, "turned_off" => (isset($context["item_disabled"]) ? $context["item_disabled"] : null))));
                // line 16
                echo "            ";
            }
            // line 17
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/pages/configurations/layouts/particle-card.html.twig", "/opt/bitnami/apps/joomla/htdocs/administrator/components/com_gantry5/templates/pages/configurations/layouts/particle-card.html.twig");
    }
}

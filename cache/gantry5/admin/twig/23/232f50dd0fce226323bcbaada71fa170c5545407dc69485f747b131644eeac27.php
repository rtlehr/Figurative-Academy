...
class __TwigTemplate_f3e9121d182453e3eaa6d5a67fe6c1d777a9d8604dc406861362c00f0d51550c extends Twig_Template
{
            ...
            if (($context["group"] != "hidden")) {
                ...
                foreach ($context['_seq'] as $context["id"] => $context["particle"]) {
                    ...
                    if ( !$this->getAttribute($context["particle"], "hidden", array())) {
                        // line 31
                        echo "                                ";
                        $context["particle"] = $this->getAttribute($this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "page", array()), "getBlueprintForm", array(0 => $context["id"]), "method");
                        // line 32
                        echo "                                ";
                        ...
                        if ($this->getAttribute($this->getAttribute($this->getAttribute($context["particle"], "form", array()), "fields", array()), "enabled", array())) {
                            ...
                            if ((isset($context["overrideable"]) ? $context["overrideable"] : null)) {
                                // line 47
                                echo "                                                ";
                                $this->loadTemplate("forms/override.html.twig", "@gantry-admin/pages/configurations/page/page.html.twig", 47)->display(array_merge($context, array("scope" => (isset($context["prefix"]) ? $context["prefix"] : null), "name" => "enabled", "field" => array("label" => (("Enabled of the " . $this->getAttribute($context["particle"], "name", array())) . " Particle")))));
                                // line 48
                                echo "                                            ";
                            }
                            // line 49
                        ...
                        echo "                                    </h4>
                                    ...
                                    <div class=\"inner-params\">
                                        ";
                        // line 53
                        $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/configurations/page/page.html.twig", 53)->display(array_merge($context, array("ignore_not_overrideable" => true, "overrideable" => (isset($context["overrideable"]) ? $context["overrideable"] : null), "blueprints" => $this->getAttribute($context["particle"], "form", array()), "skip" => array(0 => "enabled"), "prefix" => (isset($context["prefix"]) ? $context["prefix"] : null))));
                        // line 54
                        echo "                                    </div>
                                </div>
                            ";
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/pages/configurations/page/page.html.twig", "/opt/bitnami/apps/joomla/htdocs/administrator/components/com_gantry5/templates/pages/configurations/page/page.html.twig");
    }
}
